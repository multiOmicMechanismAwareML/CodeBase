...
growthLoc = 3487; %(BIOMASS rxn index). Please replace with the variables being predicted in the machine learning framework, if different from the growth rate.
